...
<section class="section magee-section alchem-home-section-0 alchem-home-style-2" id="<?php echo $section_id;?>">
        ...
        <div id="" class=" row">
          <div class="col-md-6">
            ...
            <div style="text-align:center;">
              <a href="<?php echo $btn_link;?>" target="<?php echo $btn_target;?>" class=" magee-btn-normal btn-full-rounded btn-md btn-line" id=""><?php echo $btn_text;?></a></div>
          </div>
